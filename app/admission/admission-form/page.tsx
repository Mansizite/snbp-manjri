...
export default function AdmissionProcessPage() {
  return (
    <main className="min-h-screen bg-gray-50 animate-pageFadeIn transition-opacity duration-1000">
      {/* Header */}
      <div className="bg-primary text-white py-16 animate-fadeIn transition-opacity duration-1000">
      ...
      {/* Breadcrumb */}
      <div className="bg-white border-b animate-fadeIn delay-200 transition-opacity duration-1000">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center text-sm">
            <Link href="/" className="text-gray-500 hover:text-primary transition-all duration-300">
              Home
            </Link>
            <span className="mx-2 text-gray-400">/</span>
            <Link href="/admission" className="text-gray-500 hover:text-primary transition-all duration-300">
              Admission
            </Link>
            <span className="mx-2 text-gray-400">/</span>
      ...
      {/* Content */}
      <div className="container mx-auto px-4 py-12 animate-fadeIn delay-400 transition-opacity duration-1000">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Sidebar */}
          <div className="lg:col-span-1 animate-fadeIn delay-600 transition-opacity duration-1000">
            <div className="bg-white p-6 rounded-lg shadow-md sticky top-24 transition-transform transform hover:scale-105 hover:shadow-xl">
              ...
              <ul className="space-y-2">
                ...
                <li className="border-l-4 border-transparent hover:border-primary pl-3 text-gray-600 hover:text-primary transition-colors duration-300">
              ...
              <div className="mt-8 bg-gray-50 p-4 rounded-lg border">
                ...
                <Button className="w-full mb-2 transition-all duration-300 transform hover:scale-105 hover:bg-primary hover:text-white">Apply Online</Button>
                <Button variant="outline" className="w-full transition-all duration-300 transform hover:scale-105 hover:bg-primary hover:text-white">
                  Download Form
                </Button>
              </div>
            </div>
          ...
          {/* Main Content */}
          <div className="lg:col-span-2 space-y-8 animate-fadeIn delay-800 transition-opacity duration-1000">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <form className="space-y-4">
                ...
                <div className="mt-6">
                  <Button type="submit" className="w-full transition-all duration-300 transform hover:scale-105 hover:bg-primary hover:text-white">Submit Enquiry</Button>
                </div>
              </form>
            </div>
            ...
            <div className="mt-6">
              <Link href="/admission">
                <Button variant="outline" className="flex items-center transition-all duration-300 transform hover:scale-105 hover:bg-primary hover:text-white">
