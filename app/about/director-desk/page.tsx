...
export default function DirectorDeskPage() {
  return (
    <main className="min-h-screen bg-gray-50 fade-in">
      {/* Header */}
      <div className="bg-primary text-white py-16 fade-in">
      ...
      <div className="bg-white border-b fade-in">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center text-sm">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-primary font-medium">Director Desk</span>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-8 fade-in">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="text-gray-800 fade-in">
                ...
                <p>Director, SNBP's INTERNATIONAL School</p>
              </div>
            </div>

            <div className="mt-6">
              <Link href="/about">
                <Button variant="outline" className="flex items-center fade-in">
