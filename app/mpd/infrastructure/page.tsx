...
function Page() {
  return (
    <div className="container mx-auto px-6 py-10 bg-gray-100 animate-pageFadeIn">
      <h1 className="text-4xl font-extrabold text-primary mb-12 text-center animate-fadeIn">
        School Infrastructure
      </h1>
      
      {/* Single Card */}
      <div className="bg-white p-8 rounded-xl shadow-xl max-w-5xl mx-auto hover:shadow-2xl transition-shadow duration-300 animate-fadeIn">
        <div className="space-y-8">
          
          {/* Total Campus Area Section */}
          <div className="flex items-center space-x-6 hover:bg-gray-50 p-3 rounded-xl transition-all duration-200 animate-fadeIn">
          ...
          <div className="flex items-center space-x-6 hover:bg-gray-50 p-3 rounded-xl transition-all duration-200 animate-fadeIn delay-100">
          ...
          <div className="flex items-center space-x-6 hover:bg-gray-50 p-3 rounded-xl transition-all duration-200 animate-fadeIn delay-200">
          ...
          <div className="flex items-center space-x-6 hover:bg-gray-50 p-3 rounded-xl transition-all duration-200 animate-fadeIn delay-300">
          ...
          <div className="flex items-center space-x-6 hover:bg-gray-50 p-3 rounded-xl transition-all duration-200 animate-fadeIn delay-400">
            <Home className="h-8 w-8 text-primary" />
            <div>
          ...
          <div className="flex items-center space-x-6 hover:bg-gray-50 p-3 rounded-xl transition-all duration-200 animate-fadeIn delay-500">
            <Home className="h-8 w-8 text-primary" />
            <div>
          ...
          <div className="flex items-center space-x-6 hover:bg-gray-50 p-3 rounded-xl transition-all duration-200 animate-fadeIn delay-600">
